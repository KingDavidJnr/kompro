  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 flex w-full max-w-lg flex-col rounded-lg border border-slate-200 bg-white shadow-xl max-h-[90vh]">
        ...
        {footer && <div className="flex flex-none justify-end gap-2 border-t border-slate-100 px-5 py-4">{footer}</div>}
      </div>
    </div>
  );
}
...
export function SearchableSelect({
  ...
  return (
    <div className="relative" ref={wrapRef}>
      ...
      {open && (
        <div style={dropdownStyle} className="overflow-hidden rounded-md border border-slate-200 bg-white shadow-lg">
