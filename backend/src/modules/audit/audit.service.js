 ...
 * @param {object} input - { actorId, action, entity, entityId, before, after }.
 * @returns {object} Created audit log row.
 */
async function recordAudit({ actorId, action, entity, entityId, before, after }) {
 ...
 * @param {object} req - Express request carrying req.user.
...
async function recordFromRequest(req, { action, entity, entityId, before, after }) {
  ...
  return recordAudit({ actorId, action, entity, entityId, before, after });
}
...
module.exports = { recordAudit, recordFromRequest, listAudit, getAudit };
